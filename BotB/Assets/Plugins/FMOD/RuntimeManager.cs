...
namespace FMODUnity
{
    ...
    public class RuntimeManager : MonoBehaviour
    {
        ...
        void Initialiase(bool forceNoNetwork)
        {
            ...
            else
            {
                try
                {
                    ...
                    LoadBank(fmodSettings.MasterBank.Name + ".strings");
                }
        ...
        public static void LoadBank(BankRef bankRef, bool loadSamples = false) { LoadBank(bankRef.Name);  }
        ...
        public static void UnloadBank(BankRef bankRef) { UnloadBank(bankRef.Name); }
        ...
        public static FMOD.Studio.EventInstance CreateInstance(EventRef eventRef) { return CreateInstance(eventRef.Path); }
        ...
        public static FMOD.Studio.EventDescription GetEventDescription(EventRef eventRef) { return GetEventDescription(eventRef.Path); }

        public static FMOD.Studio.EventDescription GetEventDescription(string path) { return GetEventDescription(PathToGUID(path)); }
